...
This project was my very first and still unfinished Sinatra application based on Blizzard Entertainments newest game: Overwatch!

The ultimate goal behind this assignment is to create an Overwatch character API, HOWEVER, I would like to develop this application further to encorporate more of the game titles statistics also. If you are interested in contributing to this project and further collaboration towards the complete development of an Overwatch API, please contact me, fork this repository and/or make a pull request. 
...
Please complete the following procedure to run the program on a live system:
  ...
  3. Then run the commands `$ git clone https://github.com/kteich88/overwatch_api.git` and `$ cd overwatch_api`
